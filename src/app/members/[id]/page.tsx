                ...
                <div className="md:col-span-1 space-y-6">
                    <div className="card">
                        ...
                        <div className="space-y-3">
                            <div>
                                <span className="label text-muted-foreground">Numer telefonu</span>
                            ...
                            <div className="pt-4 flex gap-2">
                                <Link href={`/members/${id}/edit`} className="btn btn-outline w-full">
                                    Edytuj dane
                                </Link>
                            </div>
                            <div className="pt-2">
                ...
                <div className="md:col-span-2 space-y-6">
                    <div className="card">
                        <div className="flex justify-between items-center mb-4">
                            ...
                            <Link href={`/members/${id}/memberships/new`} className="btn btn-primary btn-sm text-sm">
                                Sprzedaj Karnet
                            </Link>
                        </div>
                                    ...
                                    {member.memberships.length === 0 ? (
                                        ...
                                        member.memberships.map((membership) => (
                                            <tr key={membership.id}>
                                                ...
                                                <td>{new Date(membership.purchaseDate).toLocaleDateString("pl-PL")}</td>
                                                <td>
                                                    {membership.type.type === "TIME" ? (
                                                        <>
                                                            {new Date(membership.startDate).toLocaleDateString("pl-PL")} -{" "}
                                                            {membership.endDate
                                                                ? new Date(membership.endDate).toLocaleDateString("pl-PL")
                                                                : "?"}
                                                        </>
                                                    ) : (
