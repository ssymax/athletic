            ...
            <div className="grid grid-cols-3 gap-6 mb-6">
                <Card>
                    <div className="flex flex-col">
                        <span className="text-xs text-muted font-medium mb-1 uppercase tracking-wider">Aktywni Klubowicze</span>
                ...
                <Card>
                    <div className="flex flex-col">
                        <span className="text-xs text-muted font-medium mb-1 uppercase tracking-wider">Sprzedaż Dzisiaj</span>
                        <div className="flex items-center justify-between">
                            <span className="stat-value">{(todaySales._sum.totalAmount || 0).toFixed(2)} PLN</span>
                            <span className="text-xl">💰</span>
                        </div>
                    </div>
                </Card>
                <Card>
                    <div className="flex flex-col">
                        <span className="text-xs text-muted font-medium mb-1 uppercase tracking-wider">Aktywne Karnety</span>
                        <div className="flex items-center justify-between">
                    ...
                    <div className="flex flex-col gap-3">
                        {recentCheckins.length === 0 ? (
                            ...
                            recentCheckins.map((checkin) => (
                                <div key={checkin.id} className="panel-soft flex items-center justify-between p-3">
                                    <div className="flex items-center gap-3">
                                        <div className="dot dot-success"></div>
                                        <span className="font-medium">{checkin.membership.member.firstName} {checkin.membership.member.lastName}</span>
                                    </div>
                        ...
                        <Link href="/checkin" className="text-sm font-medium text-primary mt-2">Zobacz wszystkie wejścia &rarr;</Link>
                    </div>
                </Card>
